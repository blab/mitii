...
I've done that for you for samples from the Rubelt et al twins study and put them in a `.zip` archive in the `bcells/data` directory.
...
plotCompareGeneUsage(v_gene_comp)
```
What do you think?
